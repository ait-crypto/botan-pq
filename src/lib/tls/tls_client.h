...
class BOTAN_PUBLIC_API(2,0) Client final : public Channel
   ...
   public:
      ...
      * connection.
      *
      * Note that the server name indicator name must be a FQDN. IP addresses
      * are not allowed by RFC 6066 and may lead to interoperability problems.
      *
      ...
      *
      * @param offer_version specifies which version we will offer to the TLS
      *        server.
      *
