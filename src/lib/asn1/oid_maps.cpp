...
std::unordered_map<std::string, std::string> OIDS::load_oid2str_map()
   ...
   return std::unordered_map<std::string,std::string>{
      ...
      { "1.3.77.1", "Dilithium 2" },
      { "1.3.77.2", "Dilithium 3" },
      { "1.3.77.3", "Dilithium 5" },
      { "1.3.77.4", "Dilithium 2 AES" },
      { "1.3.77.5", "Dilithium 3 AES" },
      { "1.3.77.6", "Dilithium 5 AES" },
      { "1.3.77.7", "Picnic L1 FS" },
      { "1.3.77.9", "Picnic L1 Full" },
      { "1.3.77.10", "Picnic L3 FS" },
      { "1.3.77.12", "Picnic L3 Full" },
      { "1.3.77.13", "Picnic L5 FS" },
      { "1.3.77.15", "Picnic L5 Full" },
      { "1.3.77.16", "Picnic3 L1" },
      { "1.3.77.17", "Picnic3 L3" },
      { "1.3.77.18", "Picnic3 L5" },
      { "1.3.77.19", "SPHINCS+-Haraka-128f-robust" },
      { "1.3.77.20", "SPHINCS+-Haraka-128f-simple" },
      { "1.3.77.21", "SPHINCS+-Haraka-128s-robust" },
      { "1.3.77.22", "SPHINCS+-Haraka-128s-simple" },
      { "1.3.77.23", "SPHINCS+-Haraka-192f-robust" },
      { "1.3.77.24", "SPHINCS+-Haraka-192f-simple" },
      { "1.3.77.25", "SPHINCS+-Haraka-192s-robust" },
      { "1.3.77.26", "SPHINCS+-Haraka-192s-simple" },
      { "1.3.77.27", "SPHINCS+-Haraka-256f-robust" },
      { "1.3.77.28", "SPHINCS+-Haraka-256f-simple" },
      { "1.3.77.29", "SPHINCS+-Haraka-256s-robust" },
      { "1.3.77.30", "SPHINCS+-Haraka-256s-simple" },
      { "1.3.77.31", "SPHINCS+-SHA256-128f-robust" },
      { "1.3.77.32", "SPHINCS+-SHA256-128f-simple" },
      { "1.3.77.33", "SPHINCS+-SHA256-128s-robust" },
      { "1.3.77.34", "SPHINCS+-SHA256-128s-simple" },
      { "1.3.77.35", "SPHINCS+-SHA256-192f-robust" },
      { "1.3.77.36", "SPHINCS+-SHA256-192f-simple" },
      { "1.3.77.37", "SPHINCS+-SHA256-192s-robust" },
      { "1.3.77.38", "SPHINCS+-SHA256-192s-simple" },
      { "1.3.77.39", "SPHINCS+-SHA256-256f-robust" },
      { "1.3.77.40", "SPHINCS+-SHA256-256f-simple" },
      { "1.3.77.41", "SPHINCS+-SHA256-256s-robust" },
      { "1.3.77.42", "SPHINCS+-SHA256-256s-simple" },
      { "1.3.77.43", "SPHINCS+-SHAKE256-128f-robust" },
      { "1.3.77.44", "SPHINCS+-SHAKE256-128f-simple" },
      { "1.3.77.45", "SPHINCS+-SHAKE256-128s-robust" },
      { "1.3.77.46", "SPHINCS+-SHAKE256-128s-simple" },
      { "1.3.77.47", "SPHINCS+-SHAKE256-192f-robust" },
      { "1.3.77.48", "SPHINCS+-SHAKE256-192f-simple" },
      { "1.3.77.49", "SPHINCS+-SHAKE256-192s-robust" },
      { "1.3.77.50", "SPHINCS+-SHAKE256-192s-simple" },
      { "1.3.77.51", "SPHINCS+-SHAKE256-256f-robust" },
      { "1.3.77.52", "SPHINCS+-SHAKE256-256f-simple" },
      { "1.3.77.53", "SPHINCS+-SHAKE256-256s-robust" },
      { "1.3.77.54", "SPHINCS+-SHAKE256-256s-simple" },
...
std::unordered_map<std::string, OID> OIDS::load_str2oid_map()
   ...
   return std::unordered_map<std::string,OID>{
      ...
      { "Dilithium 2", OID({1,3,77,1}) },
      { "Dilithium 3", OID({1,3,77,2}) },
      { "Dilithium 5", OID({1,3,77,3}) },
      { "Dilithium 2 AES", OID({1,3,77,4}) },
      { "Dilithium 3 AES", OID({1,3,77,5}) },
      { "Dilithium 5 AES", OID({1,3,77,6}) },
      ...
      { "Picnic L1 FS", OID({1,3,77,7}) },
      { "Picnic L1 Full", OID({1,3,77,9}) },
      { "Picnic L3 FS", OID({1,3,77,10}) },
      { "Picnic L3 Full", OID({1,3,77,12}) },
      { "Picnic L5 FS", OID({1,3,77,13}) },
      { "Picnic L5 Full", OID({1,3,77,15}) },
      { "Picnic3 L1", OID({1,3,77,16}) },
      { "Picnic3 L3", OID({1,3,77,17}) },
      { "Picnic3 L5", OID({1,3,77,18}) },
      ...
      { "SPHINCS+-Haraka-128f-robust", OID({1,3,77,19}) },
      { "SPHINCS+-Haraka-128f-simple", OID({1,3,77,20}) },
      { "SPHINCS+-Haraka-128s-robust", OID({1,3,77,21}) },
      { "SPHINCS+-Haraka-128s-simple", OID({1,3,77,22}) },
      { "SPHINCS+-Haraka-192f-robust", OID({1,3,77,23}) },
      { "SPHINCS+-Haraka-192f-simple", OID({1,3,77,24}) },
      { "SPHINCS+-Haraka-192s-robust", OID({1,3,77,25}) },
      { "SPHINCS+-Haraka-192s-simple", OID({1,3,77,26}) },
      { "SPHINCS+-Haraka-256f-robust", OID({1,3,77,27}) },
      { "SPHINCS+-Haraka-256f-simple", OID({1,3,77,28}) },
      { "SPHINCS+-Haraka-256s-robust", OID({1,3,77,29}) },
      { "SPHINCS+-Haraka-256s-simple", OID({1,3,77,30}) },
      { "SPHINCS+-SHA256-128f-robust", OID({1,3,77,31}) },
      { "SPHINCS+-SHA256-128f-simple", OID({1,3,77,32}) },
      { "SPHINCS+-SHA256-128s-robust", OID({1,3,77,33}) },
      { "SPHINCS+-SHA256-128s-simple", OID({1,3,77,34}) },
      { "SPHINCS+-SHA256-192f-robust", OID({1,3,77,35}) },
      { "SPHINCS+-SHA256-192f-simple", OID({1,3,77,36}) },
      { "SPHINCS+-SHA256-192s-robust", OID({1,3,77,37}) },
      { "SPHINCS+-SHA256-192s-simple", OID({1,3,77,38}) },
      { "SPHINCS+-SHA256-256f-robust", OID({1,3,77,39}) },
      { "SPHINCS+-SHA256-256f-simple", OID({1,3,77,40}) },
      { "SPHINCS+-SHA256-256s-robust", OID({1,3,77,41}) },
      { "SPHINCS+-SHA256-256s-simple", OID({1,3,77,42}) },
      { "SPHINCS+-SHAKE256-128f-robust", OID({1,3,77,43}) },
      { "SPHINCS+-SHAKE256-128f-simple", OID({1,3,77,44}) },
      { "SPHINCS+-SHAKE256-128s-robust", OID({1,3,77,45}) },
      { "SPHINCS+-SHAKE256-128s-simple", OID({1,3,77,46}) },
      { "SPHINCS+-SHAKE256-192f-robust", OID({1,3,77,47}) },
      { "SPHINCS+-SHAKE256-192f-simple", OID({1,3,77,48}) },
      { "SPHINCS+-SHAKE256-192s-robust", OID({1,3,77,49}) },
      { "SPHINCS+-SHAKE256-192s-simple", OID({1,3,77,50}) },
      { "SPHINCS+-SHAKE256-256f-robust", OID({1,3,77,51}) },
      { "SPHINCS+-SHAKE256-256f-simple", OID({1,3,77,52}) },
      { "SPHINCS+-SHAKE256-256s-robust", OID({1,3,77,53}) },
      { "SPHINCS+-SHAKE256-256s-simple", OID({1,3,77,54}) },
